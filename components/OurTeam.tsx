...
export default function OurTeam() {
  const Team = [
   ...
   const exclusive = [
    {
      id: 1,
      avatar: "/exclusivepartners/emerald.jpg",
      name: "Emerald Estates",
      // title: "Founder & CEO",
    },
    {
      id: 2,
      avatar: "/exclusivepartners/infinity.png",
      name: "Vastitude Construction LLP",
      // title: "Director",
    },
      {
      id: 3,
      avatar:"/exclusivepartners/Sunrise.png",
